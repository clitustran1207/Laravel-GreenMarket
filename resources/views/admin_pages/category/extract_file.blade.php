...
@endsection
@section('breadcrumbs')
    {{Breadcrumbs::render('extractFileCategory')}}
@endsection
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card-box table-responsive">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered table-colored table-custom" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th>Position</th>
