...
@section('content')    
    <div class="card-box">
        <form action="{{route('editPro',$product->id)}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="row">
                <div class="col-md-6">
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{$product->pro_name}}" placeholder="Enter Name" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="price">Price</label>
                                    <input type="text" placeholder="Enter Price" name="price" data-a-sign="VNĐ " value="{{$product->price}}"  class="form-control autonumber" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter Promotion Price" name="promotion_price" data-a-sign="VNĐ " value="{{$product->promotion_price}}" class="form-control autonumber">
                                    <span class="font-14 text-muted">e.g. "VNĐ 1,234,567"</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="promotion_item" name="promotion_item" value="{{$product->promotion_item}}" placeholder="Enter Promotion Item">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Quantity</label>
                                    <input type="text" class="form-control" name="quantity" placeholder="Enter Quantity" value="{{$product->quantity}}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="textarea" name="summary" class="form-control" maxlength="225" rows="3" placeholder="The Summary content has a limit of 225 chars." required>{{$product->summary}}</textarea>
                        </div>
                        <div class="form-group">
                            <div class="checkbox checkbox-primary">
                                <input id="checkbox1" type="checkbox" name="today" value="1" @if($product->today==1) checked @endif>
                ...
                <div class="col-md-6">
                    <div class="card-box">
                        <div class="form-group">
                            ...
                            <textarea id="textarea" name="seo_keywords" class="form-control" maxlength="225" rows="3" placeholder="The SEO keywords content has a limit of 225 chars." required>{{$product->seo_keywords}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="seo_description">SEO Description</label>
                            <textarea id="textarea" name="seo_description" class="form-control" maxlength="225" rows="3" placeholder="The SEO description content has a limit of 225 chars." required>{{$product->seo_description}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="image">Image</label>
                            <div class="row">
                                <div class="col-md-7">
                                    <img src="admin/assets/images/product/thumbnail/{{$product->thumbnail}}" alt="image" class="img-fluid img-thumbnail" width="200" style="margin-bottom:1rem;margin-right:0.5rem"/>
                                    @foreach($pro_img as $img)
                                    <img src="admin/assets/images/product/detail/{{$img->url}}" alt="image" class="img-fluid img-thumbnail" width="200" style="margin-bottom:1rem;margin-right:0.5rem"/>
                                    @endforeach
                                </div>
                                <div class="col-md-5">
                ...
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <form method="post">
                            <textarea id="elm1" name="detail">{{$product->detail}}</textarea>
                        </form>
                    </div>
                </div>
